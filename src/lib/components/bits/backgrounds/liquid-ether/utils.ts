...
export function createLiquidEther(container: HTMLElement, options: any) {
    ...
    const bgVec4 = new THREE.Vector4(0, 0, 0, 1); // opaque black
    ...
    class WebGLManager {
        ...
        init() {
            ...
            console.log("LiquidEther: WebGL Initialized (v2)");
        }
        resize() {
            Common.resize();
            this.output.resize();
    ...
    return new WebGLManager({
        ...
        takeoverDuration: options.takeoverDuration,
        autoResumeDelay: options.autoResumeDelay,
        autoRampDuration: options.autoRampDuration,
    });
}
