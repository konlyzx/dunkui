<script lang="ts">
    let lineColor = $state("#8b5cf6");
    let speed = $state(1);
    let perspective = $state(600);
    let fade = $state(true);
    ...
    const props = [
        {
            ...
            type: "string",
            default: "'#8b5cf6'",
            desc: "Hex color for grid lines.",
        },
        {
            name: "speed",
            type: "number",
            default: "1",
            desc: "Grid scroll animation speed multiplier.",
        },
        {
            name: "perspective",
            type: "number",
            default: "600",
            desc: "CSS perspective depth in pixels.",
        },
        {
            name: "fade",
            type: "boolean",
            default: "true",
            desc: "Applies a fade gradient at the edges.",
        },
    ];
</script>

<svelte:head><title>Retro Grid — DunkUI</title></svelte:head>
<div class="comp-page">
    <h2 class="sub-category">Retro Grid</h2>
    <div class="tabs-bar">
        <div class="tabs-left">
            <button
                class="tab-trigger"
    ...
    {#if activeTab === "preview"}
        <div class="demo-container">
            <div class="preview-box">
                <div class="retro-demo">
                    <div class="retro-grid">
                        {#each Array(12) as _, i}<div
                                class="line-h"
                                style="bottom:{i *
                                    8.33}%;background:{lineColor}33"
                            ></div>{/each}
                        {#each Array(15) as _, i}<div
                                class="line-v"
                                style="left:{i *
                                    7.14}%;background:{lineColor}33"
                            ></div>{/each}
                    </div>
            ...
            <div class="preview-options">
                ...
                <div class="opt-row">
                    <span class="opt-label">Line Color</span><input
                        type="color"
                        bind:value={lineColor}
                        class="color-input"
                    /><span class="opt-val">{lineColor}</span>
                </div>
                <div class="opt-row">
                ...
                <div class="opt-row">
                    <span class="opt-label">Perspective</span><input
                        type="range"
                        bind:value={perspective}
                        min={100}
                        max={1200}
                        step={50}
                    /><span class="opt-val">{perspective}</span>
                </div>
                <div class="opt-row">
                    <span class="opt-label">Fade</span><label class="switch"
                        ><input type="checkbox" bind:checked={fade} /><span
                            class="switch-track"
    ...
    {#if activeTab === "contribute"}<div class="contribute-container">
            <p>Want to improve this component?</p>
            <a
