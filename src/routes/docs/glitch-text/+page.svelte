<script lang="ts">
    let text = $state("DUNKUI");
    let intensity = $state(1.5);
    let speed = $state(2);
    let color1 = $state("#f43f5e");
    ...
    const props = [
        {
            ...
            type: "string",
            default: "'DUNKUI'",
            desc: "The text content to render with glitch effect.",
        },
        {
            name: "intensity",
            type: "number",
            default: "1.5",
            desc: "Controls how far chromatic layers shift in px.",
        },
        {
            name: "speed",
            type: "number",
            default: "2",
            desc: "Animation cycle speed in seconds.",
        },
        {
            name: "colors",
            type: "string[]",
            default: '["#f43f5e","#38bdf8"]',
            desc: "Two hex colors for the chromatic split channels.",
        },
    ];
</script>

<svelte:head><title>Glitch Text — DunkUI</title></svelte:head>
<div class="comp-page">
    <h2 class="sub-category">Glitch Text</h2>
    <div class="tabs-bar">
        <div class="tabs-left">
            <button
                class="tab-trigger"
            ...
            <div class="preview-box">
                <div class="glitch-demo">
                    <span
                        class="glitch-text"
                        data-text={text}
                        style="--c1:{color1};--c2:{color2}">{text}</span
                    >
                </div>
            </div>
