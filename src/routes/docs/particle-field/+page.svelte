    ...
    const props = [
        {
            ...
            type: "number",
            default: "200",
            desc: "Total number of particles rendered on the canvas.",
        },
        {
            name: "speed",
            type: "number",
            default: "0.8",
            desc: "Velocity multiplier for particle drift movement.",
        },
        {
            name: "connectDistance",
            type: "number",
            default: "120",
            desc: "Max pixel distance for drawing connecting lines.",
        },
        {
            name: "color",
            type: "string",
            default: "'#8b5cf6'",
            desc: "Base hex color for particles and connection lines.",
        },
        {
            name: "mouseReact",
            type: "boolean",
            default: "true",
            desc: "Whether particles scatter on cursor proximity.",
        },
    ];
</script>

<svelte:head><title>Particle Field — DunkUI</title></svelte:head>

<div class="comp-page">
    <h2 class="sub-category">Particle Field</h2>
            ...
            <div class="preview-options">
                ...
                <div class="option-row">
                    ...
                    <input
                        ...
                        step={10}
                    />
                    <span class="option-val">{count}</span>
                </div>
                <div class="option-row">
                    ...
                    <input
                        ...
                        step={0.1}
                    />
                    <span class="option-val">{speed}</span>
                </div>
                <div class="option-row">
                    <span class="option-label">Connect Distance</span>
                    <input
                        type="range"
                        ...
                        step={10}
                    />
                    <span class="option-val">{connectDistance}</span>
                </div>
                <div class="option-row">
                ...
                <div class="option-row">
                    ...
                    <input
                        ...
                        class="color-input"
                    />
                    <span class="option-val">{color}</span>
                </div>
            </div>
        </div>
    {/if}
    ...
    {#if activeTab === "code"}
        <div class="code-container"><pre><code>{codeString}</code></pre></div>
    {/if}
